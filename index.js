const http = require('http'); // truy cập module thông  qua http
...
// using method createServer trên module create new instance  trên http server  và lưu trữ trong server variable
